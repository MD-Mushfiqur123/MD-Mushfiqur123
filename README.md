...
#### 🏛 Higher Secondary Student (HSC '28) at Govt. Azizul Haque College, Bogura
  ...
  <tr style="border: none;">
    <td width="64%" style="border: none; vertical-align: top;">
      ...
      <ul>
        ...
        <li>⚡ <b>Extreme Quantization Research:</b> 1.58-bit & 2-bit Ternary Residual Quantization (<b>M-2LRF</b>) with 0-DSP multiplier arithmetic and 0.000% catastrophic forgetting across 1,000,000+ lines.</li>
...
+------------------------------+------------------------------+
        ...
        v                      v                      v
+---------------+      +---------------+      +---------------+
|  CSA2 Sparse  |      |     Hyper-    |      |  DSpark & MTP |
|   Attention   |      |  Connections  |      |  Speculative  |
| (Sliding+TopK)|      | (4-Way Stream)|      |  Draft Heads  |
+---------------+      +---------------+      +---------------+
        |                      |                      |
        +----------------------+----------------------+
                               |
  ...
  <tr style="border: none;">
    <td width="65%" style="border: none; vertical-align: top;">
      <table border="1" cellpadding="8" style="border-collapse: collapse; border-color: #30363d; width: 100%;">
        ...
        <tr>
          <td>☁️ <b><a href="https://github.com/awslabs/mcp">AWS Labs (awslabs/mcp)</a></b></td>
...
### ☁️ Cloud Platforms, Distributed Systems & DevOps
<div align="center">
  <a href="https://skillicons.dev">
